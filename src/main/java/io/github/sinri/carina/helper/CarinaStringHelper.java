...
public class CarinaStringHelper {
    ...
    public String bufferToHexMatrix(Buffer buffer, int rowSize) {
        ...
        String s = CarinaHelpers.binaryHelper().encodeHexWithUpperDigits(buffer);
    ...
    public String fromUnderScoreCaseToCamelCase(String underScoreCase) {
        ...
        return CarinaHelpers.stringHelper().joinStringArray(camel, "");
    }
    ...
    public String fromCamelCaseToUserScoreCase(String camelCase) {
        ...
        return CarinaHelpers.stringHelper().joinStringArray(parts, "_");
    }
    ...
    public byte[] encodeWithBase64ToBytes(String s) {
        return CarinaHelpers.binaryHelper().encodeWithBase64(s.getBytes());
    }
