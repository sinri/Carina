...
public class Carina {
    private final static CarinaConfiguration configuration = CarinaConfiguration.createFromJsonObject(new JsonObject());
    private static @Nullable Vertx vertx;
    private static @Nullable ClusterManager clusterManager;

    public static CarinaConfiguration getConfiguration() {
